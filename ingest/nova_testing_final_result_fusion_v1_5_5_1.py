...
def build_prompt(source):
    """
    v1.5.5.1 prompt: choose ONE enum value, never echo schema alternatives,
...
def analyze_sources(
    ...
    analyses = []
    cache_dir = (
        Path(output_dir) / "page_analysis_cache_v1_5_5_1"
    )
    cache_dir.mkdir(parents=True, exist_ok=True)
