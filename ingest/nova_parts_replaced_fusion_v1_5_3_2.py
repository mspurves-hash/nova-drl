#!/usr/bin/env python3
"""
Nova DRL Parts Replaced Fusion v1.5.3.2
=====================================

Extracts conservative part candidates from HUMAN-APPROVED repair actions that
have already passed through the v1.5.2.5 terminology layer.
...
- Does not modify v1.5.1 or v1.5.2.5 artifacts.
