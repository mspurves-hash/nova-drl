#!/usr/bin/env python3
"""
Nova DRL Full-Corpus Unified Knowledge Search + Print v1.5.4

Engineer-facing presentation layer over the full v1.5.2 repair corpus and full DRL file index.

Key additions:
- simplified vertical parts ranking: Part Number + Times Replaced only, highest to lowest,
...
def command_plan(args) -> int:
    ...
    print("v1.5.4: full-corpus knowledge + vertical parts ranking + Windows Engineer Client + auto-open PDF")
    print("Search/database schema:          v1.5.3 full-corpus DB schema reused; v1.5.4 presentation only")
