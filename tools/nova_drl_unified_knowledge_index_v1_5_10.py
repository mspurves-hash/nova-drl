#!/usr/bin/env python3
"""
Nova DRL Global Resolver Consolidation — Corpus-Only Product View v1.5.10
...
def aggregate_product_parts(conn, families: Sequence[str], base_part_number: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    v1.5.10 keeps v1.5.8's correct event-level counting but replaces the overly
...
def command_plan(args) -> int:
    ...
    print("v1.5.10: structured parts_replaced aggregation + corpus-only component-core resolver + minimal product view")
    print("Search/database schema:          v1.5.3 full-corpus DB reused; v1.5.10 resolves product + component cores from structured parts_replaced evidence at query time")
