...
script. v1.4.11 reuses that DB and does not change the frozen repair corpus.
"""
...
def command_status(args) -> int:
    # The storage engine is still v1.4.8 schema; v1.4.11 is the presentation/print layer.
...
def command_plan(args) -> int:
    ...
    print("v1.4.11 presentation additions: blue actions; clickable + plain browser PDF URL; direct :print; Windows shortcut kit")
