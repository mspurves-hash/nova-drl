...
$remoteTool = "/opt/nova-drl/tools/nova_drl_unified_knowledge_index_v1_5_3.py"
...
if (-not (Test-Path $KeyPath)) {
    throw "NOVA DRL SSH key not found: $KeyPath`nRe-run the NOVA DRL v1.5.3 Windows installer."
}

Clear-Host
Write-Host "Nova DRL Windows Engineer Client v1.5.3" -ForegroundColor Cyan
