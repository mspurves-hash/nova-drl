# Nova DRL v1.5.3.2 — Parts Replaced Hardening
...
- Revision reissue of the v1.5.3.1 parts hardening under a new filename/version so Git can detect the files cleanly; semantic policy remains unchanged.
