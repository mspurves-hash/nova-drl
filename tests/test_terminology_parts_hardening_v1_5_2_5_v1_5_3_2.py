...
terms = load("terms1524", ROOT / "ingest" / "nova_drl_terminology_v1_5_2_5.py")
parts = load("parts1531", ROOT / "ingest" / "nova_parts_replaced_fusion_v1_5_3_2.py")
glossary = terms.load_glossary(ROOT / "config" / "drl_terminology_v1_5_2_5.json")
part_terms = parts.load_part_terms(ROOT / "config" / "drl_part_terms_v1_5_3_2.json")
...
print("PASS: coordinated Nova DRL v1.5.2.5 + v1.5.3.2 integration test")
