...
SCRIPT = ROOT / "tools" / "nova_drl_unified_knowledge_index_v1_4_10.py"
spec = importlib.util.spec_from_file_location("v1410", SCRIPT)
...
def main():
    ...
    print("PASS: Nova DRL Unified Knowledge Search + Print v1.4.10 tests")
