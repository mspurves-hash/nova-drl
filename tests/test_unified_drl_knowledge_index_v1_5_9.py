...
UI = ROOT / 'tools' / 'nova_drl_unified_knowledge_index_v1_5_9.py'

def load(name, path):
    spec = importlib.util.spec_from_file_location(name, path)
    mod = importlib.util.module_from_spec(spec); sys.modules[name] = mod; spec.loader.exec_module(mod); return mod

eng = load('v153_engine_for_v159_test', ENGINE)
ui = load('v159_ui_test', UI)
...
print('PASS: Nova DRL 80/20 Reference-PN Resolver v1.5.9 tests')
