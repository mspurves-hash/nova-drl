...
SCRIPT = ROOT / "analysis" / "nova_gb8_technician_answer_composer_v1_3_8_3.py"
...
def test_render_displays_support_and_policy():
    ...
    assert "Y Axis Drift [rg_a; 10 serials/14 logs]" in text
...
if __name__ == "__main__":
    ...
    for fn in tests:
        fn()
    print("PASS: Nova DRL GB8 Technician Answer Composer v1.3.8.3 tests")
